<template>
  <v-container align="center" class="w-50">
    <div class="d-flex flex-column justify-space-evenly fill-height">
      <div class="text-h4 font-weight-bold text-primary pa-10">CREA UNA CUENTA</div>
      <v-form ref="form" v-model="valid" @submit.prevent="submitcuenta">
        ...
        <v-text-field v-model="cuenta.psw" :rules="passwordRules" type="password" label="Confirmar Contraseña" variant="outlined"></v-text-field>
